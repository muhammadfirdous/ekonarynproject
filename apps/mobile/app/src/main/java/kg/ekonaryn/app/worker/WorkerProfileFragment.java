...
public class WorkerProfileFragment extends Fragment {
    ...
    private TextView textName, textPhone, avatar, textCollectionsCount, textTotalWeight;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_workerprofile, container, false);
    }
    ...
    public void onViewCreated(@NonNull View v, @Nullable Bundle savedInstanceState) {
        ...
        textCollectionsCount = v.findViewById(R.id.textCollectionsCount);
    ...
    private void loadStats() {
        ...
        Async.run(() -> ApiClient.get().getCollections(token, 200),
                items -> {
                    ...
                    textCollectionsCount.setText(String.valueOf(count));
                    textTotalWeight.setText(String.format(Locale.US, "%.1f", total));
                },
                err -> { /* leave defaults */ });
    }
    ...
    private void renderInfo(User user) {
        ...
        addRow(inf, "🏷", getString(R.string.profile_field_role), getString(R.string.role_worker_job));
    }
