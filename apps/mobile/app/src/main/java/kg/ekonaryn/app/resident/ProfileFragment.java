...
public class ProfileFragment extends Fragment {
    ...
    private TextView textName, textPhone, textPoints, badgeRole, avatar;
    ...
    public void onViewCreated(@NonNull View v, @Nullable Bundle savedInstanceState) {
        ...
        badgeRole = v.findViewById(R.id.badgeRole);
        ...
        if (user != null) {
            ...
            badgeRole.setText(roleBadge(user.role));
            renderInfo(user);
        }
    ...
    private void renderInfo(User user) {
        ...
        addRow(inf, "🏷", getString(R.string.profile_field_role), roleLabel(user.role));
    }
    ...
    private String roleLabel(String role) {
        if ("WORKER".equals(role)) return getString(R.string.role_worker);
        if ("ADMIN".equals(role)) return getString(R.string.role_admin);
        return getString(R.string.role_resident);
    }

    private String roleBadge(String role) {
        if ("WORKER".equals(role)) return getString(R.string.badge_worker);
        if ("ADMIN".equals(role)) return getString(R.string.badge_admin);
        return getString(R.string.badge_resident);
    }
